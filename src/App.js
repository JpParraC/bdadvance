...
import ForgotPassword from './views/pages/login/forgotpassword'; // Ajusta la ruta si es necesario

import ResetPassword from './views/pages/login/resetpassword'; // Ajusta la ruta si es necesario
