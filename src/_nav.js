...
const _nav = [
  ...
  },
  {
    component: CNavItem,
    name: 'Test Page',
    to: '/base/test-page', // Asegúrate de que esta ruta coincida con la que configuraste en tus rutas
    icon: <CIcon icon={cilStar} customClassName="nav-icon" />, // Puedes usar cualquier icono que desees
  },
